  ...
  return (
    ...
    >
      ...
      <div className="container">
        <div className="border-green-700 bg-green-200 flex w-full rounded-lg border-l-[6px] px-7 py-8 md:p-9">
          <div className="bg-green-700 mr-5 flex h-[34px] w-full max-w-[34px] items-center justify-center rounded-md">
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
